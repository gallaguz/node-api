...
export const STATUS_CODES_MESSAGES_MAP: Record<TStatusCodes, string> = {
     ...
     */
    [REDIRECT.FOUND_PREVIOUSLY_MOVED_TEMPORARILY]:
     ...
     */
    [REDIRECT.USE_PROXY]: 'Use Proxy',
    /**
     * 306 UNUSED
     *
     * This response code is no longer used; it is just reserved. It was used in a previous version of the HTTP/1.1 specification.
     */
    [REDIRECT.SWITCH_PROXY]: 'Switch Proxy',
    /**
     * 307
     *
     ...
     */
    [CLIENT_ERROR.PROXY_AUTHENTICATION_REQUIRED]:
     ...
     */
    [CLIENT_ERROR.IM_A_TEAPOT]: 'I"m a Teapot',
    /**
     * 421
     *
     ...
     */
    [CLIENT_ERROR.REQUEST_HEADER_FIELDS_TOO_LARGE]:
     ...
     */
    [CLIENT_ERROR.UNAVAILABLE_FOR_LEGAL_REASONS]:
     ...
     */
    [INTERNAL_SERVER_ERROR.NOT_IMPLEMENTED]: 'Not Implemented',
    /**
     * 502
     *
     * This error response means that the server, while working as a gateway to get a response needed to handle the request, got an invalid response.
     */
    [INTERNAL_SERVER_ERROR.BAD_GATEWAY]: 'Bad Gateway',
    /**
     * 503
     *
     * The server is not ready to handle the request. Common causes are a server that is down for maintenance or that is overloaded. Note that together with this response, a user-friendly page explaining the problem should be sent. This response should be used for temporary conditions and the Retry-After HTTP header should, if possible, contain the estimated time before the recovery of the service. The webmaster must also take care about the caching-related headers that are sent along with this response, as these temporary condition responses should usually not be cached.
     */
    [INTERNAL_SERVER_ERROR.SERVICE_UNAVAILABLE]: 'Service Unavailable',
    /**
     * 504
     *
     * This error response is given when the server is acting as a gateway and cannot get a response in time.
     */
    [INTERNAL_SERVER_ERROR.GATEWAY_TIMEOUT]: 'Gateway Timeout',
    /**
     * 505
     *
     * The HTTP version used in the request is not supported by the server.
     */
    [INTERNAL_SERVER_ERROR.HTTP_VERSION_NOT_SUPPORTED]:
     ...
     */
    [INTERNAL_SERVER_ERROR.VARIANT_ALSO_NEGOTIATES]: 'Variant Also Negotiates',
    /**
     * 507
     *
     * The method could not be performed on the resource because the server is unable to store the representation needed to successfully complete the request.
     */
    [INTERNAL_SERVER_ERROR.INSUFFICIENT_STORAGE]: 'Insufficient Storage',
    /**
     * 508
     *
     * The server detected an infinite loop while processing the request.
     */
    [INTERNAL_SERVER_ERROR.LOOP_DETECTED]: 'Loop Detected',
    /**
     * 510
     *
     * Further extensions to the request are required for the server to fulfill it.
     */
    [INTERNAL_SERVER_ERROR.NOT_EXTENDED]: 'Not Extended',
    /**
     * 511
     *
     * Indicates that the client needs to authenticate to gain network access.
     */
    [INTERNAL_SERVER_ERROR.NETWORK_AUTHENTICATION_REQUIRED]:
